...
// Source: github.com/mchirico/mock-playground/pkg/car/imp (interfaces: CAR)
...
import (
	...
	imp "github.com/mchirico/mock-playground/pkg/car/imp"
	reflect "reflect"
)
...
func (m *MockCAR) EngineCheck(arg0 *gin.Context, arg1 imp.CAR) bool {
	m.ctrl.T.Helper()
...
func (m *MockCAR) Start(arg0 *gin.Context, arg1 string, arg2 imp.CAR) bool {
	m.ctrl.T.Helper()
